...
A comprehensive RAG (Retrieval-Augmented Generation) application that creates a queryable digital persona based on Facebook and LinkedIn data exports.
...
│   ├── tests.jsonl                # 25 test questions (LLM-generated)
